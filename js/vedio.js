...
const loadCatagories = () => {
  ...
  fetch("https://openapi.programming-hero.com/api/phero-tube/categories")
    .then((res) => res.json())
    .then((data) => displayCatagories(data.categories)) // array ta displayCategories ar moddhe pathai dicchi
...
const loadVideos = (searchText = "") => {
  ...
  fetch(
    ...
    .then((res) => res.json())
    .then((data) => displayVideos(data.videos)) // array ta displayCategories ar moddhe pathai dicchi
    .catch((error) => console.log(error));
};
...
const loadCatagoriesVideos = (id) => {
  ...
  fetch(`https://openapi.programming-hero.com/api/phero-tube/category/${id}`)
    .then((res) => res.json())
    .then((data) => {
      // sobaika active class remove korao

      removeActiveClass();

      // id er class ka active kora
